"""Launch HW6 P3 - TEST CASE B - kintester URDF

   ros2 launch hw6sols hw6p3bsol.launch.py
...
def generate_launch_description():
    ...
    urdf = os.path.join(pkgdir('hw6code'), 'urdf/kintester.urdf')
